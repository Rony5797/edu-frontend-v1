    ...
    <MasterLayout>
      ...
      <div className="flex justify-center">
        <div className="text-center mt-8">
          ...
          <u>
            <p className="text-[20px]">নাজেরা বিভাগ</p>
          </u>
          <p>১০/৮/২০২৪</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white border border-gray-300 mb-4 mt-4 rounded-lg shadow-lg">
            <thead className="bg-[#236bc2] text-white">
              <tr>
          ...
          <div className="flex justify-end mb-8 mt-2">
            <button className="text-[white] bg-[#236bc2] font-semibold text-[18px] px-3 py-2 flex justify-center hover:bg-[#236bc2c6]">
