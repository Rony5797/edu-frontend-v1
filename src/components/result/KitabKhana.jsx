    ...
    <MasterLayout>
      ...
      <div className="flex justify-center">
        <div className="text-center mt-8">
          ...
          <u>
            <p className="text-[20px]">কিতাব খানা</p>
          </u>
          <p>১০/৮/২০২৪</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        <div className="overflow-x-auto">
          ...
          <div className="flex justify-end mb-8 mt-2">
            <button className="text-[white] bg-[#8e44ad] font-semibold text-[18px] px-3 py-2 flex justify-center hover:bg-[#8d44add4]">
